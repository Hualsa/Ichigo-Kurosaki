...
╚════════
  `
  let but = [
  {urlButton: {displayText: 'Source Code ♨️',url: 'https://youtube.com/channel/UC5jaRLAdMkgxoLf8t9N37dw'}}, 
  {urlButton: {displayText: 'Website 🔗',url: 'https://discord.gg/gWDSgWhQ22'}}, 
...
case 'sc': case 'sourcecode': case 'script': {
  m.reply('*Script Berasal Dari :* https://github.com/Hualsa/Ichigo-Kurosaki/edit/master/command/ichi.js\n\nJangan Lupa Bintang nya!')
  }
  break
case 'owner': {
